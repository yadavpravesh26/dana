...
<html lang="en">
   <head>
      ...
      <title><?php if(isset($_REQUEST['id'])){echo "Edit";} else{"Add";}?> Quotations/Estimations - Dana World Cont Co. Wll</title>
      <!-- Bootstrap Core CSS -->
          ...
          <div class="container-fluid">
             <div class="row mana-top">
                <div class="col-sm-3 sp-row">
                   <span class="head-title">Add Quotations/Estimations</span>
                </div>
             </div>
                      ...
                      <div class="row bx-shd">
                         ...
                         <div class="row">
                            <div class="col-sm-3">
                               <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="Estimation Number" name="estNumber" value="<?php echo $curr_val['estNumber'];?>" required>
                               </div>
                            </div>
                            <div class="col-sm-3">
                               <div class="form-group">
                                  <label>Estimation Created Date</label>
                                  <input type="text" class="form-control mydatepicker" placeholder="Estimation Created Date" value="<?php echo date("m/d/Y", strtotime($curr_val['estCreatedDate']));?>" name="estCreatedDate" required>
                               </div>
                            </div>
                            <div class="col-sm-3">
                               <div class="form-group">
                                  <label>Estimation Created By</label>
                            ...
                            <div class="col-sm-3">
                               <label>Type of Estimation</label>
                               <select class="form-control select2" name="estType" required>
                                  <option value="TradingQuotation">Trading Quotation</option>
                                  <option value="AK">AMC Quotation</option>
                            ...
                            <div class="col-sm-12 p-0 m-t-30">
                               ...
                               <div class="form-group">
                                 <textarea class="textarea_editor6 form-control" name="subjectOfQuotation" rows="3" placeholder="Enter text ..."></textarea>
                               </div>
                            </div>
                            <!--end-->
                            <div class="col-sm-12 m-t-30">
                                ...
                                <label class="wid-100">&nbsp;</label>
                                 ...
                                 <table id="productTable" class="table table-hover table-bordered" style="width:100%;">
                                  ...
                                  <tfoot>
                                     <tr>
                                        <td colspan="7" class="text-right"><strong class="total">Total:</strong></td>
                                        <td class="text-right">
                                     ...
                                     <tr>
                                        <td colspan="7" class="text-right"><strong class="total">Discount:</strong></td>
                                        <td class="text-right"><strong class="total"><span id="discount">0</span></strong>
                                        </td>
                                        <td></td>
                                     </tr>
                                     <tr>
                                        <td colspan="7" class="text-right"><strong class="total">Grand Total:</strong></td>
                         ...
                         <div class="row cls-btm m-t-20">
                            ...
                            <div class="col-sm-2 text-right m-t-20" style="margin-left: -40px;">
                               <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="btnSubmit"><?php if(isset($_REQUEST['id'])){echo "Update";} else{"Save";}?></button>
	...
	?>
	  ...
	  <?php if(isset($_REQUEST['id'])){
		...
		<tr <?php if($i==0){?>id="mainRow"<?php } ?>>
           ...
           <td>
             <input  type="number" class="form-control" name="pQTY[]" value="<?php echo $row[$i]["pQTY"]; ?>" required  />
           </td>
           <td>
		...
		<?php }
         ...
         <tr id="mainRow">
           ...
           <td>
             <input type="number" class="form-control" name="pTax[]" required />
           </td>
           <td>
