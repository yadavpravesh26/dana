                     ...
                     <div class="table-responsive bx-shd">
                        <table id="myTable" class="table table-striped table-bordered act-adjust">
                           ...
                           <tbody>
                              <tr>
                                 <td>PO-33456</td>
                                 <td>Triumph Supplies</td>
                                 <td>Road Construction</td>
                                 <td>James wan</td>
                                 <td>Trading Quotation</td>
                                 <td>12/07/2019</td>
                                 <td>55636646</td>
                                 <td class="text-nowrap text-center">
                                    <a href="add-quotation.php" data-toggle="tooltip" data-original-title="Edit"> <span class="label-edit"><i class="ti-pencil"></i></span> </a>
                                    <a onClick="printDiv('printMe')" data-toggle="tooltip" data-original-title="Print"> <span class="label-print"><i class="ti-printer"></i></span> </a>
                                    <a href="#" data-toggle="tooltip" data-original-title="Convert As Job"> <span class="label-job" alt="alert" class="img-responsive model_img"><i class="ti-briefcase"></i></span> </a>
                                    <a href="#" data-toggle="tooltip" data-original-title="Delete"> <span class="label-delete qts-sts" alt="alert" class="img-responsive model_img"><i class="ti-trash"></i></span> </a>
                                 </td>
                              </tr>
                              <tr>
                                 <td>PO-33456</td>
